...
extension ListVC: UITableViewDelegate, UITableViewDataSource {
    ...
    //actually deleting cells from table view
    ...
    //ability to move (rearrange) rows in a table
    ...
    func tableView(_ tableView: UITableView, canEditRowAt indexPath: IndexPath) -> Bool {
        //ternary operator method ("if *blank* is not equal to 0, return turn, else return false)
