...
//  WeatherGift
//
//  Created by Kerry Nasta on 3/17/18.
...
extension DetailVC: CLLocationManagerDelegate {
    ...
    func handleLocationAuthorizationStatus(status: CLAuthorizationStatus) {
        ...
        case .denied:
            showAlertToPrivacySettings(title: "User has not authorized location services", message: "Select Settings below to enable location services in this app")
        case .restricted:
            showAlert(title: "Location services denied", message: "Check what is restricting location use in this app")
        }
    }
